    ...
    <div class="main-content">
        ...
        <div class="shelf-section">
            <div class="shelf-header">
                ...
                <a href="#">Full shelf <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg></a>
            </div>
            <div class="shelf">
                <a href="{{ route('user.show', ['id' => 1]) }}" class="book-item">
                    <img src="https://covers.openlibrary.org/b/id/8235012-L.jpg" alt="Book Cover">
                    <p>Book Title 1</p>
                </a>
                <a href="{{ route('user.show', ['id' => 2]) }}" class="book-item">
                    <img src="https://covers.openlibrary.org/b/id/7222106-L.jpg" alt="Book Cover">
                    <p>Book Title 2</p>
                </a>
                <a href="{{ route('user.show', ['id' => 3]) }}" class="book-item">
                    <img src="https://covers.openlibrary.org/b/id/7891721-L.jpg" alt="Book Cover">
                    <p>Book Title 3</p>
                </a>
                <a href="{{ route('user.show', ['id' => 4]) }}" class="book-item">
                    <img src="https://covers.openlibrary.org/b/id/8235012-L.jpg" alt="Book Cover">
                    <p>Book Title 1</p>
                </a>
                <a href="{{ route('user.show', ['id' => 5]) }}" class="book-item">
                    <img src="https://covers.openlibrary.org/b/id/7222106-L.jpg" alt="Book Cover">
                    <p>Book Title 2</p>
                </a>
                <a href="{{ route('user.show', ['id' => 6]) }}" class="book-item">
                    <img src="https://covers.openlibrary.org/b/id/7891721-L.jpg" alt="Book Cover">
                    <p>Book Title 3</p>
                </a>
            </div>
        ...
        <div class="shelf-section">
            ...
            <div class="shelf">
                <a href="{{ route('user.show', ['id' => 7]) }}" class="book-item">
                    <img src="https://covers.openlibrary.org/b/id/8235012-L.jpg" alt="Book Cover">
                    <p>Book Title 4</p>
                </a>
                <a href="{{ route('user.show', ['id' => 8]) }}" class="book-item">
                    <img src="https://covers.openlibrary.org/b/id/7222106-L.jpg" alt="Book Cover">
                    <p>Book Title 5</p>
                </a>
                <a href="{{ route('user.show', ['id' => 9]) }}" class="book-item">
                    <img src="https://covers.openlibrary.org/b/id/7891721-L.jpg" alt="Book Cover">
                    <p>Book Title 6</p>
                </a>
                <a href="{{ route('user.show', ['id' => 10]) }}" class="book-item">
                    <img src="https://covers.openlibrary.org/b/id/8235012-L.jpg" alt="Book Cover">
                    <p>Book Title 4</p>
                </a>
                <a href="{{ route('user.show', ['id' => 11]) }}" class="book-item">
                    <img src="https://covers.openlibrary.org/b/id/7222106-L.jpg" alt="Book Cover">
                    <p>Book Title 5</p>
                </a>
                <a href="{{ route('user.show', ['id' => 12]) }}" class="book-item">
                    <img src="https://covers.openlibrary.org/b/id/7891721-L.jpg" alt="Book Cover">
                    <p>Book Title 6</p>
                </a>
            </div>
